...
#################################################
    ...
    if(center_x - horizontal_error < corner_x < center_x + horizontal_error
            and center_y - vertical_error < corner_y < center_y + vertical_error ):
        if (extRight[0] > (img_w - horizontal_error) and direction != 3):
            ...
            direction = 2
            print("down")
    if (extBot[1] > (img_h - vertical_error) and extTop[1] < vertical_error/2):
        # print("IT HAS ENTERED", prev_direction)
        if(direction == 0 or direction == 2):
            prev_direction = direction
    elif(extLeft[0] < horizontal_error  and extRight[0] > (img_w - horizontal_error) ):
        # print("IT HAS ENTERED", prev_direction)
